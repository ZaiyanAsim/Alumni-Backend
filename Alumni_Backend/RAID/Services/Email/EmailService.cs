...
namespace Alumni_Portal.RAID.Services
{
    public class EmailService
    {
        ...
        public EmailService(LoginService loginService, IHttpClientFactory httpClientFactory, ILogger<EmailService> logger)
        {
            ...
            _logger = logger;
            client = _httpClientFactory.CreateClient("AuthorizedRAIDClient");
        ...
        public async Task SendMailAsync(int client_Id, ICollection<string> toEmail, ICollection<string> ccEmail, string subject, string message)
        {
